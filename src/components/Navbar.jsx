    ...
    return(
        <div>
            <motion.div className="container mx-auto md:flex hidden justify-between items-center py-6" initial={{opacity:0,y:-100}} animate={{opacity:1,y:0}} transition={{duration:0.5}}>
                ...
                <a className="md:text-base lg:text-lg bg-[#00bcd4] hover:bg-cyan-600 text-white px-4 py-2 rounded-full duration-2" href="/Dhiraj_Salgare_9822384717.pdf" Download>Dowload Resume</a>
            </motion.div>
